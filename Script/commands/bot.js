...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Aminul") || (event.body.toLowerCase() == "Aminul") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Aminul ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Akash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100056502654253\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01776885***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:AMINUL ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস আমিনুল আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is AMINUL ッ❤️ তাকে সবাই আমিনুল নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Eti") || (event.body.toLowerCase() == "Eti")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আকাশ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "afsana") || (event.body.toLowerCase() == "Afsana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আকাশ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Beplob ") || (event.body.toLowerCase() == "বিপ্লব")) {
     return api.sendMessage("🥰-বিপ্লব-🌺 আমার বস আমিনুল'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Mimi") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "ami aminul") || (event.body.toLowerCase() == "kire")) {
